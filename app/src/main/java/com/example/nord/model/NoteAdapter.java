...
public class NoteAdapter extends FirestoreRecyclerAdapter<NoteTransfer, NoteAdapter.NoteHolder> {
    ...
    private int getRandomColor() {
        ...
        colorCode.add(com.example.nord.R.color.lightPurple);
    ...
    public NoteHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(com.example.nord.R.layout.note_item, parent, false);
    ...
    class NoteHolder extends RecyclerView.ViewHolder{
        ...
        public NoteHolder(@NonNull View itemView) {
            super(itemView);
            textViewTitle = itemView.findViewById(com.example.nord.R.id.text_view_title);
            textViewDescription = itemView.findViewById(com.example.nord.R.id.text_view_description);
            textViewPriority = itemView.findViewById(com.example.nord.R.id.text_view_priority);
            noteCardView = itemView.findViewById(com.example.nord.R.id.noteCardView);
