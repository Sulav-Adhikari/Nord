...
import com.example.nord.DetailsPass;
...
public class PassAdapter extends FirestoreRecyclerAdapter<PassTransfer, PassAdapter.PassHolder> {
    ...
    class PassHolder extends RecyclerView.ViewHolder{
        ...
        public PassHolder(@NonNull View itemView) {
            super(itemView);
            passViewPlatform = itemView.findViewById(com.example.nord.R.id.pass_view_platform);
            passViewPassword = itemView.findViewById(com.example.nord.R.id.pass_view_password);
            passCardView = itemView.findViewById(com.example.nord.R.id.passCardView);
