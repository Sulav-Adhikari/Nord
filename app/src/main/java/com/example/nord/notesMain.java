...
import com.example.nord.model.NoteAdapter;
import com.example.nord.model.NoteTransfer;
...
public class notesMain extends AppCompatActivity{
    ...
    private void setUpRecyclerView() {
        Query query = db.collection("Notebook").document(user.getUid()).collection("myNotes").orderBy("priority", Query.Direction.ASCENDING);
